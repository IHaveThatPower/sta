...
export class STAStarshipSheet extends STAActorSheet {
  static SHEET_TEMPLATE = 'systems/sta/templates/actors/starship-sheet.html';
  ...
  activateListeners(html) {
    ...
    // Open attached smll craft
    this._activateLaunchBayListeners(html);
    ...
    this._handleTrackerEvent(html, '[id^="crew"]', '#total-crew', this.object.system.crew.value);
  ...
  /**
   * Activate listeners that open attached small craft sheets
   *
   * @param object html
   * @return  void
   */
  _activateLaunchBayListeners(html)
  {
